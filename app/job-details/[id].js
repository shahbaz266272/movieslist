          ...
          {isLoading ? (
            ...
            <View style={tw`bg-white shadow-md h-full overflow-auto px-2 py-3`}>
              ...
              <View style={tw`flex flex-row gap-2 mt-2`}>
                <Text style={tw`text-[#f4511e] text-2xl font-semibold `}>
                  {data?.title}
                </Text>
              </View>
              <View style={tw`flex flex-row justify-between mt-2`}>
                <View
                  style={tw`flex flex-row gap-2  bg-[#f4511e] rounded-full py-1 px-2 w-auto `}
                >
                  <Text style={tw`text-white text-xl font-semibold  `}>
                    {data?.date?.slice(0, 10)}
                  </Text>
                </View>
                <Text style={tw`text-[#f4511e] text-xl font-semibold `}>
                  <Rating
                    type="heart"
                    readonly
                    ratingCount={5}
              ...
              <View
                style={tw`flex flex-row gap-2 mt-2 bg-[#f4511e] rounded-lg px-2 py-3`}
              >
                <Text style={tw`text-white text-xl font-semibold `}>
                  {data?.reviews}
                </Text>
